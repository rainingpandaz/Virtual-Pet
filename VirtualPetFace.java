...
public class VirtualPetFace extends JFrame implements ActionListener {
  ...
  public static void main(String args[]) {
      ...
      {
     System.out.println("Since your pet is healthy, it will work out");
      pet.workout();
      }
  }
  ...
  public class CentredBackgroundBorder implements Border {
    ...
    public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
      g.drawImage(
          image, 0, 0, VirtualPetFace.this.getWidth(), VirtualPetFace.this.getHeight(), null);
    }
